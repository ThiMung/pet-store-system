...
<div class="pb-5" style="background: linear-gradient(90deg, #ff7eb3, #ff758c); min-height: 320px;">
    <div class="container pt-4 pb-2">
        ...
        <div class="text-center text-white mb-4" style="opacity:.9;">Mang đến niềm vui và hạnh phúc cho gia đình bạn với những bạn nhỏ đáng yêu</div>
    </div>
</div>
    ...
    <div class="row justify-content-center">
        <div class="col-lg-10">
            ...
            <div class="bg-danger bg-gradient rounded shadow p-4 text-white mt-4">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-2"><i class="bi bi-geo-alt-fill me-2"></i> Địa Chỉ: 123 Đường Nguyễn Văn Linh, Quận 7, TP. HCM</div>
                        <div class="mb-2"><i class="bi bi-envelope-fill me-2"></i> Email: contact@petshop.vn</div>
                    </div>
                    <div class="col-md-6">
                        <div class="mb-2"><i class="bi bi-telephone-fill me-2"></i> Điện Thoại: 0123 456 789</div>
                        <div class="mb-2"><i class="bi bi-clock-fill me-2"></i> Giờ Mở Cửa: Thứ 2 - Chủ Nhật: 8:00 - 20:00</div>
                    </div>
                </div>
            </div>
        </div>
